...
```
[정보] 캘리브레이션 이미지 13장 발견

[Step 1] 체크보드 코너 검출 시작...
  [성공] left01.jpg: 코너 54개 검출
  [성공] left02.jpg: 코너 54개 검출
  [실패] left03.jpg: 코너 미검출, 제외됨
  [성공] left04.jpg: 코너 54개 검출
  ...
[정보] 캘리브레이션에 사용할 이미지: 11장

[Step 2] 카메라 캘리브레이션 수행 중...

==================================================
카메라 내부 파라미터 행렬 K [3x3]:
==================================================
[[532.xx   0.   342.xx]
 [  0.   532.xx 233.xx]
 [  0.     0.     1.  ]]

  fx (수평 초점거리): 532.xx px
  fy (수직 초점거리): 532.xx px
  cx (주점 x좌표):   342.xx px
  cy (주점 y좌표):   233.xx px

왜곡 계수 [k1, k2, p1, p2, k3]:
==================================================
[[-0.2xxx  0.1xxx  0.000x  0.000x -0.0xxx]]

  재투영 오차 (RMS): 0.xxxx px
```
